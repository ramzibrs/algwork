...
<div class="main-banner" id="top">
    ...
    <div class="video-overlay header-text">
        <div class="caption">
            <br>
            <form action="{{url('entrer-annonce')}}" id="ft-form" method="POST" accept-charset="UTF-8" enctype="multipart/form-data">
                @csrf
                <!--<fieldset>
                  <legend>Job</legend>
                  <label>
                ...
                <fieldset>
                  ...
                  <div class="two-cols">
                    <h6>
                      titre *
                      <input type="text" style=" background-color: #d1d1d1; color:#000000" name="titre" required>
                    </h6>
                    <h6>
                      sous titre *
                      <input type="text" style=" background-color: #d1d1d1; color:#000000" name="soustitre" required>
                    </h6>
                  </div>
                  <div class="two-cols">
                    <h6>
