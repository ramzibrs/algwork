...
@section('content')
    ...
    <!-- ***** Call to Action End ***** -->
    <br>
    <form class="form-inline my-2 my-lg-0 pr-5" type="get" action="{{ url ('searchp') }}">
            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    <h4>resultat trouvé par nom :</h4>
                      <br>
                    <div class="row">
                        @foreach ($projetsea as $item )
                        @if ($item->approuvé==1)
                        <div class="col-md-6">
                            <div class="trainer-item">
                                <div class="image-thumb">
                                    <img src="{{asset('images/projet/images/'.$item->photo)}}" alt="image here" style="height: 350px ;width: 510px">
                                </div>
                                <div class="down-content">
                                    ...
                                    <ul class="social-icons">
                                        <li><a href="{{url('prjvue/' .$item->id)}}">+ View More</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                            ...
                            border-color: green; //your color
                                    ...
                                    <nav>
                                      <ul class="pagination pagination-lg justify-content-center ">
                                            ...
                                            {{ $projetsea->withQueryString()->links()  }}
