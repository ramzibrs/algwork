...
@section('content')
    ...
    <form class="form-inline my-2 my-lg-0 pr-5" type="get" action="{{ url ('searchc/' .$travaille->id)}}">
        <input class="form-control col-md-10 container" name="query" type="search" placeholder="rechercher par nom /prenom /wilaya /genre" aria-label="Search">
    ...
    <section class="section" id="trainers">
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    <h4>resultat trouvé par nom :</h4>
                      <br>
                    <div class="row">
                        @foreach ($candidaturen as $item )
                        @if ($item->intitule==$travaille->intitule)
                        @if ($item->approuvé==1)
                        <div class="col-md-6">
                            <div class="trainer-item">
                                <div class="image-thumb">
                                    <embed src="{{asset('images/candidature/cv/'.$item->cv)}}" alt="cv" style="height: 350px ;width: 510px">
                                </div>
                                <div class="down-content">
                                    ...
                                    <ul class="social-icons">
                                        <li><a href="{{url('empvuec/' .$item->id)}}">+ View More</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                            ...
                            border-color: green; //your color
                                    ...
                                    <nav>
                                      <ul class="pagination pagination-lg justify-content-center ">
                                            ...
                                            {{ $candidaturen->withQueryString()->links() }}
