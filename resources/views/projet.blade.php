...
<div class="main-banner" id="top">
    ...
    <div class="video-overlay header-text">
        <div class="caption">
            <br>
            <form name="form" action="{{url('entrer-projet')}}" id="ft-form" method="POST"  accept-charset="UTF-8" enctype="multipart/form-data">
                @csrf
                <!--<fieldset>
                  <legend>Job</legend>
                  <label>
                ...
                <fieldset>
                    <br><br>
                  <h5 class="btn btn-primary">Personal data</h5>
                    <div id="id1">
                  <div class="two-cols">
                    <h6>
                      intitule du projet *
                      <input type="text" id="input1" style=" background-color: #d1d1d1; color:#000000" name="intitule" required>
                    </h6>
                    <h6>
                      type de projet *
                      <select name="type" id="input2" style="background-color: #d1d1d1; color:#000000" required>
                  ...
                  <div class="two-cols">
                    <h6>
                      les besoins
                      <input type="text" id="input3" style=" background-color: #d1d1d1; color:#000000" name="besoins" >
                    </h6>
                    <h6>
                       les bénéficier
                      <input type="text" id="input4" style=" background-color: #d1d1d1; color: #000000" name="beneficier" >
                    </h6>
                  </div>
                  <div class="two-cols">
                    <h6>
                      les condition
                      <input type="text" id="input5" style=" background-color: #d1d1d1; color:#000000" name="condition" >
                    </h6>
                    <h6>
                        wilaya *
                        <select name="wilaya" id="input6" style="background-color: #d1d1d1; color:#000000" required>
                  ...
                  <div>
                    <button   class="btn btn-primary col-md-4 " onclick="suivant(this);" style="float: right">suivent</button>
                  </div>
                  ...
                  <div class="two-cols">
                    <h6>
                        Adresse *
                        <input type="text" style=" background-color: #d1d1d1; color:#000000" name="adresse" required>
                    </h6>
                    <h6>
                        numéro de telephone *
                        <input type="tel" style=" background-color: #d1d1d1; color:#000000" name="phone" required>
                    </h6>
                  </div>
                  <div class="two-cols">
                    <h6>
                        Adresse email
                        <input type="email" style=" background-color: #d1d1d1;  color:#000000" name="Email" >
                    </h6>
                    <h6>
                      description *
                      <textarea name="description"  rows="3" style=" background-color: #d1d1d1;  color:#000000" class="form-control" required></textarea>
                    </h6>
                  </div>
                  <div class="two-cols">
                  <h6>
               ...
               <div>
                  <button type="submit"  class="btn btn-primary col-md-4 " style="float: right">valider</button>
                </form>
                <button  onclick="retour(this);" class="btn btn-primary col-md-4 " style="float: left ; color:white">retour</button>
              </div>
             </div>
          </fieldset>
