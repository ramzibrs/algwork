...
<div class="main-banner" id="top">
    ...
    <div class="video-overlay header-text">
        <div class="caption">
            <br>
            <form action="{{url('misecv/' .$cv->id)}}" id="ft-form" method="POST" accept-charset="UTF-8" enctype="multipart/form-data">
                @csrf
                <!--<fieldset>
                  <legend>Job</legend>
                  <label>
                ...
                <fieldset>
                  ...
                  <div class="two-cols">
                    <h6>
                      nom *
                      <input type="text" value="{{ $cv->nom}}" style=" background-color: #d1d1d1; color:#000000" name="nom" required>
                    </h6>
                    <h6>
                      prenom *
                      <input type="text" value="{{ $cv->prenom}}" style=" background-color: #d1d1d1; color:#000000" name="prenom" required>
                    </h6>
                  </div>
                  <div class="two-cols">
                    <h6>
                      Date de naissance *
                      <input type="date" value="{{ $cv->date_de_naissanse}}" style=" background-color: #d1d1d1; color:#000000" name="date" required>
                    </h6>
                    <h6>
                  ...
                  <h6>
                    Adresse *
                    <input type="text" value="{{ $cv->adresse}}" style=" background-color: #d1d1d1; color:#000000" name="adresse" required>
                  </h6>
                  <h6>
                    wilaya *
                  <select name="wilaya" style="background-color: #d1d1d1; color:#000000" required>
                    <option value="{{ $cv->nom_wilaya}}">{{$cv->nom_wilaya}} </option>
                    @foreach ($wilaya as $item)
                    @if ($item->nom!=$cv->nom_wilaya)
                  ...
                  <div class="two-cols">
                    <h6>
                      numéro de telephone *
                      <input type="tel" value="{{ $cv->numero_de_telephone}}" style=" background-color: #d1d1d1; color:#000000" name="phone" required>
                    </h6>
                    <h6>
                      Adresse email
                      <input type="email" value="{{ $cv->adresse_email}}" style=" background-color: #d1d1d1;  color:#000000" name="Email" >
                    </h6>
                  </div>
                  <div class="two-cols">
                    <h6>
                        ...
                        <select name="genre" style="background-color: #d1d1d1; color:#000000" required>
                          <option value="{{ $cv->genre}}">{{$cv->genre}}</option>
                          @if ($cv->genre=="homme")
                    ...
                    <div> <a  href="{{ url('vcv') }}" class="btn btn-primary col-md-4 " style="float: left ; color:white">retour</a>
