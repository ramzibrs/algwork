...
<div class="main-banner" id="top">
    ...
    <div class="video-overlay header-text">
        <div class="caption">
            <br>
            <form action="{{url('entrer-cv')}}" id="ft-form" method="POST" accept-charset="UTF-8" enctype="multipart/form-data">
                @csrf
                <!--<fieldset>
                  <legend>Job</legend>
                  <label>
                ...
                <fieldset>
                  ...
                  <div class="two-cols">
                    <h6>
                      nom *
                      <input type="text" style=" background-color: #d1d1d1; color:#000000" name="nom" required>
                    </h6>
                    <h6>
                      prenom *
                      <input type="text" style=" background-color: #d1d1d1; color:#000000" name="prenom" required>
                    </h6>
                  </div>
                  <div class="two-cols">
                    <h6>
                      Date de naissance *
                      <input type="date" style=" background-color: #d1d1d1; color:#000000" name="date" required>
                    </h6>
                    <h6>
                  ...
                  <div class="two-cols">
                    ...
                    <h6>
                      ...
                      <input type="file" style=" background-color: #d1d1d1; color: #000000" name="Curriculum-vital" accept=".pdf" required>
                    </h6>
                    </div>
