                        ...
                        <div class="col-md-6">
                            <div class="trainer-item">
                                ...
                                <div class="down-content">
                                    ...
                                    <h6>0{{$item->numero_de_telephone}} / {{$item->intitule}}<h6>
                                    <!--<p>Medical &nbsp;/&nbsp; Health Jobs</p>-->
                                    <br>

                                    <ul class="social-icons">
                                        @foreach ($travaille as $items )
                                        @if ($item->trv_id==$items->id)

                                        <li><a href="{{url('empvuec/' .$item->id , $items->id)}}">+ View More</a></li>
