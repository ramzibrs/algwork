...
@section('content')
    ...
    <div class="main-banner" id="top">
        ...
        <div class="video-overlay header-text">
            <div class="caption">
                <h6>vous chercher un travaille !</h6>
                <h2>vous le trouverer<em> ici</em></h2>
                <div class="main-button">
                    <a href="{{url('cv')}}">poser votre CV</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="main-banner" id="top">
        ...
        <div class="video-overlay header-text">
            <div class="caption">
                <h6>vous chercher des employeurs !</h6>
                <h2>vous les trouverer<em> ici</em></h2>
                <div class="main-button">
                    <a href="{{url('travaille')}}">decrire le travaille</a><h6>ou</h6> <a href="{{url('employeur')}}">choisir un employeur</a>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="col-lg-4">
                    <div class="trainer-item">
                        <div class="image-thumb">
                            <img src="assets1/images/product-1-720x480.jpg" alt="">
                        </div>
    ...
    <div id="carousel" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            <img class="d-block w-100" src="images/fig5.jpg" alt="Un tigre">
            <div class="carousel-caption">
              <h1>Un tigre</h1>
            </div>
          </div>
          <div class="carousel-item">
            <img class="d-block w-100" src="images/fig6.jpg" alt="Un tigre">
            <div class="carousel-caption">
              <h1>Un autre tigre</h1>
            </div>
          </div>
          <div class="carousel-item">
            <img class="d-block w-100" src="images/fig7.jpg" alt="Un tigre">
            <div class="carousel-caption">
...
<br><br>
    ...
    <section class="section section-bg" id="schedule" style="background-image: url(assets/images/about-fullscreen-1-1920x700.jpg)">
        <div class="container">
            <div class="row">
                <div class="col-lg-6 offset-lg-3">
                    <div class="section-heading dark-bg">
                        ...
                        <img src="assets1/images/line-dec.png" alt="">
                        <p>Nunc urna sem, laoreet ut metus id, aliquet consequat magna. Sed viverra ipsum dolor, ultricies fermentum massa consequat eu.</p>
                    </div>
                </div>
            </div>
            ...
            <br><br>
            <div class="main-button text-center">
                <a href="{{url('projet')}}">poser votre projet</a>
            </div>
        </div>
    </section>
    ...
    <section class="section section-bg" id="schedule" style="background-image: url(assets/images/about-fullscreen-1-1920x700.jpg)">
        <div class="container">
            ...
            <div class="main-button text-center">
                <a href="{{url('annonce')}}">poser votre annonce</a>
            </div>
        </div>
    </section>
            ...
            <div class="row" id="tabs">
              ...
              <div class="col-lg-8">
                <section class='tabs-content'>
                  <article id='tabs-1'>
                    <img src="assets1/images/blog-image-1-940x460.jpg" alt="">
                  ...
                  <article id='tabs-2'>
                    <img src="assets1/images/blog-image-2-940x460.jpg" alt="">
                  ...
                  <article id='tabs-3'>
                    <img src="assets1/images/blog-image-3-940x460.jpg" alt="">
            ...
            <div class="row">
                <div class="col-lg-6 offset-lg-3">
                    <div class="section-heading">
                        ...
                        <img src="assets1/images/line-dec.png" alt="waves">
                ...
                <div class="col-lg-6">
                    <ul class="features-items">
                        <li class="feature-item">
                            <div class="left-icon">
                                <img src="assets1/images/features-first-icon.png" alt="First One">
                            </div>
                        ...
                        <li class="feature-item">
                            <div class="left-icon">
                                <img src="assets1/images/features-first-icon.png" alt="second one">
                            </div>
                            <div class="right-content">
                                <h4>John Doe</h4>
                                <p><em>"Lorem ipsum dolor sit amet, consectetur adipisicing elit. Dicta numquam maxime voluptatibus, impedit sed! Necessitatibus repellendus sed deleniti id et!"</em></p>
                ...
                <div class="col-lg-6">
                    <ul class="features-items">
                        <li class="feature-item">
                            <div class="left-icon">
                                <img src="assets1/images/features-first-icon.png" alt="fourth muscle">
                            </div>
                            <div class="right-content">
                                <h4>John Doe</h4>
                                <p><em>"Lorem ipsum dolor sit amet, consectetur adipisicing elit. Dicta numquam maxime voluptatibus, impedit sed! Necessitatibus repellendus sed deleniti id et!"</em></p>
                        ...
                        <li class="feature-item">
                            <div class="left-icon">
                                <img src="assets1/images/features-first-icon.png" alt="training fifth">
                            </div>
                            <div class="right-content">
                                <h4>John Doe</h4>
                                <p><em>"Lorem ipsum dolor sit amet, consectetur adipisicing elit. Dicta numquam maxime voluptatibus, impedit sed! Necessitatibus repellendus sed deleniti id et!"</em></p>
